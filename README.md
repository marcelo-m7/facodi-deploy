...
| `marcelo-m7/facodi-learning` | `facodi_learning` | `8a0e3d74257ac3320504d94ccc4e0a2d7fe21a9c` |
...
Release `facodi_learning 19.0.1.40.0` fixes the authenticated portal Academic Map projection after the standard-membership refactor and adds `/my/home` to the real Odoo CI gate.
