...
class RepositoryContractTest(unittest.TestCase):
    ...
    def test_d1_learning_interfaces_browser_acceptance_contract(self):
        ...
        self.assertIn('"version": "19.0.10.5.0"', theme_manifest)
        self.assertIn('"version": "19.0.1.29.0"', learning_manifest)
    ...
    def test_permanent_editorial_redirect_release_contract(self):
        ...
        self.assertIn('"version": "19.0.10.5.0"', manifest)

        redirect_data = theme_root / "theme_facodi/data/website_rewrites.xml"
        redirect_migration = (
            theme_root
            / "theme_facodi/migrations/19.0.10.5.0/post-10-permanent-editorial-redirects.py"
        )
